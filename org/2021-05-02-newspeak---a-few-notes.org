...
* Newspeak is different.  The first week of a personal journey around the Newspeak platform
...
Which method is used on which module type? Follow the [[*Modules: Application, library, test, general][Modules: Application, library, test, general]]
...
See [[*Newspeak modules API summary][Newspeak modules API summary]] for roles of the API methods. For motivation of the APIs, see earlier sections such as [[*Modules: Application, library, test, general][Modules: Application, library, test, general]] and the whole section [[Newspeak is different.  The first week of a personal journey around the Newspeak platform]].
...
| App                                      | #packageUsing: manifest                          | #main: platform args: args                      |
| Test Configuration                       | #packageTestsUsing: manifest                     | #testModulesUsingPlatform: platform minitest: m |
|------------------------------------------+--------------------------------------------------+-------------------------------------------------|
|------------------------------------------+--------------------------------------------------+-------------------------------------------------|
|                                          | Factory Constructor.                             |                                                 |
|------------------------------------------+--------------------------------------------------+-------------------------------------------------|
...
| Module type                              | Constructor. Role=package                        | Instance method. Role=build or execute          |
|------------------------------------------+--------------------------------------------------+-------------------------------------------------|
| Library                                  | *#packageLibraryUsingManifest: manifest*         | *#buildUsingPlatform: platform*                 |
...
Also note how the passing of ~platform~ moves from the constructor in the module, to the instance method in the library:
  ...
  - To the distribution library ~RecipyWithDepLib~, it is on thr /instance method/ /#buildUsing: platform/.
...
For details see  [[*Newspeak modules API summary][Newspeak modules API summary]] and [[Develop, package, distribute ~AHelloWorldApp~ app]] for an example.
