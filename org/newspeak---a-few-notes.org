...
** Newspeak recipy for modules (top level classes) API creation

Sections above attempted to discover and describe modules API. This section will attempt to give a "recipy" which methods each module type requires.

**** 1. General module with NO dependencies: API of module with no dependencies 

While perhaps rare, this is the simplest case. If your module does not need any dependencies, not even from common classes such as collection:
...
If your module need some other module from IDE, such as collections, you have to pass it the ~platform~ object, and potentially other objects or classes your module depends on
...
If you need your module ~RecipyWithDep~ to be packagable as a library:
...
If you need your module ~RecipyWithDep~ to be packagable as an App:
...
** IN-PROGRESS-NOW Hello World in Newspeak
